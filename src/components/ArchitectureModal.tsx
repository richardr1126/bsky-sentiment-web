...
/**
 * ArchitectureModal component: displays the system architecture overview in a dialog.
 */
            ...
            <div className="px-6 pb-6 pt-5 space-y-6">
              <div className="rounded-lg border border-border/60 bg-surface-secondary/30 p-4">
                <p className="text-sm text-text-secondary leading-relaxed">
                  This dashboard visualizes sentiment analysis of posts from the{" "}
                  <a
                    href="https://bsky.app"
                    target="_blank"
                    rel="noreferrer"
              ...
              <div className="grid gap-5 text-left sm:grid-cols-2 lg:grid-cols-3">
                <div className="group space-y-2">
                  ...
                  <p className="text-xs leading-relaxed text-text-secondary">
                    <span className="font-medium">AT Protocol</span> real-time
                    data stream delivering all public posts, likes, and social
                    interactions from the Bluesky network as they happen.
                  </p>
                </div>
                <div className="group space-y-2">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs leading-relaxed text-text-secondary">
                    <span className="font-medium">Firehose Ingest</span> filters
                    and validates posts by language, length, and content
                    quality, then publishes clean data to NATS for processing.
                  </p>
                </div>
                <div className="group space-y-2">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs leading-relaxed text-text-secondary">
                    <span className="font-medium">Dual Streams</span> provide
                    durable messaging: raw posts stream for processing input,
                    enriched posts stream with sentiment for dashboard output.
                  </p>
                </div>
                <div className="group space-y-2">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs leading-relaxed text-text-secondary">
                    ...
                    AI inference for 3-class sentiment, and publishes enriched
                    results back to NATS.
                  </p>
                </div>
                <div className="group space-y-2">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs leading-relaxed text-text-secondary">
                    ...
                    subscribes to enriched NATS stream via Server-Sent Events,
                    displaying real-time sentiment analysis with filtering.
                  </p>
                </div>
                <div className="group space-y-2">
                  <div className="flex items-center gap-2">
                  ...
                  <p className="text-xs leading-relaxed text-text-secondary">
                    <span className="font-medium">GKE + Helm</span> orchestrates
                    containerized microservices on Kubernetes with automated
                    deployments, health monitoring, and horizontal scaling.
                  </p>
                </div>
              </div>
              ...
              <div className="rounded-lg border border-border/60 bg-gradient-to-br from-surface-secondary/40 to-surface-secondary/20 p-5">
                ...
                <div className="lg:hidden space-y-3">
                  ...
                  <div className="flex items-center justify-between gap-2 text-xs">
                    {/* Processor Service */}
                    <div className="flex flex-col items-center flex-1">
                      <div className="h-12 w-12 rounded-lg bg-sentiment-positive-bg border border-sentiment-positive-border flex items-center justify-center mb-2">
                        <ChartBar className="h-5 w-5 text-sentiment-positive-accent" />
                      </div>
                      <span className="font-medium text-text-primary text-center text-[11px]">
                        Processor
